...
secret_key = app.config['QINIU_SECERE_KEY']
...
def qiniu_upload_file(source_file,save_file_name):
    ...
    #ret, info = put_stream(token, save_file_name, sourse_file.stream,"qiniu",os.fstat(sourse_file.stream.fileno()).st_size)
